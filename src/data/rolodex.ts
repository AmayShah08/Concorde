...
export const destinations: Destination[] = [
  ...
  {
    id: 18,
    image: "Hotels/Lewa-Safari-Camp-Lewa-Wildlife-Conservancy.jpg",
    title: "Lewa Safari Camp - Lewa Wildlife Conservancy",
    description: "Immerse yourself in the magic of conservation and luxury at Lewa Safari Camp, where breathtaking wildlife encounters meet unparalleled comfort in the heart of Lewa Wildlife Conservancy.",
  },
  {
    id: 19,
    image: "Hotels/Lake-Manyara-Tree-Lodge-Lake-Manyara.jpg",
    title: "Lake Manyara Tree Lodge – Lake Manyara",
    description: "Hidden within an ancient mahogany forest, Lake Manyara Tree Lodge offers an intimate treehouse escape where luxury meets the enchanting wilderness of Lake Manyara.",
  },
  {
    id: 20,
    image: "Hotels/Mara-Ishara-Masai-Mara.png",
    title: "Mara Ishara – Masai Mara",
    description: "Experience the untamed beauty of the Maasai Mara in unmatched luxury at Mara Ishara Camp, where the wild meets elegance under starlit African skies.",
  },
  {
    id: 21,
    image: "Hotels/Ngorongoro-Crater-Lodge-Ngorongoro.jpg",
    title: "Ngorongoro Crater Lodge – Ngorongoro",
    description: "Perched on the edge of the iconic Ngorongoro Crater, this opulent lodge blends Maasai-inspired elegance with breathtaking panoramic views of one of Africa’s most spectacular landscapes.",
  },
  {
    id: 22,
